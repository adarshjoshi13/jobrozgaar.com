...
import ErrorFeild from '../../../Global/UI/Erorrspan/Errofeild'

function SelectTwo({ label1, label2, onchange, value1, name1, name2, value2, hideLable, hidfeild ,options1,options2,err1, err2}) {
  const selectinput ={
    fontSize:"12px",
    padding:"8px"
  }
