...
function Company({ initialValues,redirect }) {
...
{/* 
          ...
          <div className="form-1 col-md-4">
            <input style={{ width: "100%" }} type='text' className='company-details-input mt-3' placeholder='Enter Document Number*' name='CompanyVerification.DocumentNo' onChange={formik.handleChange} value={formik.values.CompanyVerification.DocumentNo} />
          ...
          <div className="form-1 col-md-4">
            <input style={{ width: "100%" }} type='text' className='company-details-input mt-3' placeholder='Enter company verfiaction *' name='CompanyVerification.CompanyVerfiaction' onChange={formik.handleChange} value={formik.values.CompanyVerification.CompanyVerfiaction} />
          ...
          <div className="form-1 col-md-4">
            <input style={{ width: "100%" }} type='text' className='company-details-input mt-3' placeholder='Enter company Pan No *' name='CompanyVerification.PanNo' onChange={formik.handleChange} value={formik.values.CompanyVerification.PanNo} />
          ...
          <div className="form-1 col-md-4">
            <input style={{ width: "100%" }} type='text' className='company-details-input mt-3' placeholder='Enter company Gst Number *' name='CompanyVerification.GstNo' onChange={formik.handleChange} value={formik.values.CompanyVerification.GstNo} />
