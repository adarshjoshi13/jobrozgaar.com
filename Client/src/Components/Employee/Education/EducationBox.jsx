    ...
    <div className="container education-box">
      <div className="row w-100">
              ...
              return (
                <div className="row mt-5 edu-box" key={index}>
                  <div className="DLT-BTN-EDUCAtion">
                    {formik.values.Courses.length === 1 ? (<h5 className='text-center'>Course</h5>) : (<h5 className='text-center'>Course {index + 1}</h5>)}
        ...
        <div className="col-md-12">
          <button className='add-more submit-btn-main mb-2' onClick={() => {
