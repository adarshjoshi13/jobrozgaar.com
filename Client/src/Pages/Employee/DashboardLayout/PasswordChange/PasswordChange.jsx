    ...
    return (
        <>
            <div className='mb-5 mt-3 change-pass'>
                ...
                <div class="col-md-12"><h4 className="mt-0 text-center mb-3" style={{color: "rgb(143, 170, 70)"}}>Change Your Password</h4></div>
                ...
                <Button onClick={formik.handleSubmit} title={loader ? <Loader /> : "Submit"}/>
